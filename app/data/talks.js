...
const data = {
	...
	'max-stoiber': {
		...
		speaker: {
			...
			name: 'Max Stoiber',
			twitter: 'mxstbr',
			summary: 'Makes styled-components, react-boilerplate, KeystoneJS and micro-analytics. Open source developer at Thinkmill. Speciality coffee geek, skier, traveller.',
		},
		time: getTime(DAY_ONE, 6),
	},
	'feather-knee': {
