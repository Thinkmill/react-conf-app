...
export const map = {
	'max-stoiber': {
		content: 'What if we took the best of JavaScript and the best of CSS, and combined them together to create the ultimate styling solution for React? Glen Maddern (CSS Modules co-creator) and I sat down and starting thinking about this. Let\'s talk about what we thought about and why we arrived where we did – 💅 styled-components.',
		title: 'The Road to Styled Components',
		speaker: {
			avatar: '//www.gravatar.com/avatar/48619fc17b3ab68472aebd56c0106278?s=128',
	...
	'jared-forsyth': {
		content: 'Tools like Flow and TypeScript promise "types for your JavaScript" - but what does that get you, exactly? What\'s the experience like of adding types to a large JavaScript project? Is the overhead worth it for you and your team? In the end, embracing type systems will give you more confidence in your code, fewer production bugs, and a much friendlier codebase.',
		title: 'Type Systems Will Make You a Better JavaScript Developer',
		speaker: {
			avatar: '//www.gravatar.com/avatar/36c528f0d1f8811f27268119b2c63eaa?s=128',
	...
	'ben-ilegbodu': {
		content: 'JavaScript is evolving quickly. The ES6 specification was released back in 2015 and has been implemented by modern browsers. New versions of ECMAScript will now be released on a yearly basis. We can leverage ES6 and functionality slated for future versions right now to write even clearer and more concise React code. Experience with React will help you get the most out of this session, but you don’t have to have a JavaScript black belt to leave feeling confident in using ES.next with React. Learn how to write cleaner code using the spread operator, destructuring, new async functions, and other features being introduced into ECMAScript. Oh, and don’t worry if you don’t understand all of those terms — you soon will after this session!',
		title: 'React + ES.next = ♥',
		speaker: {
			avatar: '//www.gravatar.com/avatar/0feb204b70c4be3d22fe27cc3f424d33?s=128',
	...
	'lin-clark': {
		content: 'React will have a new core algorithm soon with Fiber. This new algorithm improves responsiveness and perceived performance for complex pages. But to make that happen, the architecture had to be reconsidered from the ground up. In this talk, I\'ll break down the new concepts and explain what makes it seem faster.',
		title: 'A Cartoon Intro to Fiber',
		speaker: {
			avatar: '//www.gravatar.com/avatar/a1c30f951cdefc554d6e2d078a02468d?s=128',
	...
	'andres-suarez': {
		content: 'In my talk last year, "Nuclide hacks for React Native development" I briefly touched on how Flow can lead to writing better React Native apps. This year, the focus is entirely on using Nuclide\'s rich UI for Flow features to move fast with React.',
		title: 'Moving Fast with Nuclide and Flow',
		speaker: {
			avatar: '//www.gravatar.com/avatar/a533b2e0c40619f551bf54506e53ca2c?s=128',
	...
	'guillermo-rauch': {
		content: 'I\'d like to describe our journey building Next.js and what comes after :)',
		title: 'Next.js: Universal React Made Easy and Simple',
		speaker: {
			avatar: '//www.gravatar.com/avatar/486e20e16ef676a02ac0299d2f92b813?s=128',
	...
	'jing-chen': {
		content: 'Keynote Part 2: React Native',
		title: 'Keynote',
		speaker: {
			avatar: '//www.gravatar.com/avatar/f3928721841baa5ee26fbbe906348039?s=128',
	...
	'ken-wheeler': {
		content: 'An exploration in past and current alternative uses for React, non-standard rendering targets, and the future of such shenanigans.',
		title: 'Using React for Anything but Websites',
		speaker: {
			avatar: '//www.gravatar.com/avatar/4751e2e9fe7b876958d38f86a718ca91?s=128',
	...
	'cheng-lou': {
		content: 'What is a piece of code? What is a library, a tool, a platform and a language? Based on my last talk on the spectrum of abstraction, this talk explores the daily concerns and the meta-concerns of writing code, and how our new effort, Reason, relates to them.',
		title: 'Building React Components with Reason',
		speaker: {
			avatar: '//www.gravatar.com/avatar/13bede8f6aa8c5eb590995b32ca04bf2?s=128',
	...
	'sebastian-markbage': {
		content: 'Keynote Part 1: React',
		title: 'Keynote',
		speaker: {
			avatar: '//www.gravatar.com/avatar/ceb6764d18462b099b98cc6447363ef6?s=128',
	...
	'troy-connor': {
		content: 'Last year I won the diversity scholarship and this year I’m going to talk about how we can grow this community outside of our peers. I’m going to talk about the importance of diversity within the tech culture and how doing that has brought React to be as awesome as it is. Also steps we can do to improve contributing, ideas of how we can collaborate, and how we can continue to develop a environment where React can be easier for people who are intimidated to learn it.',
		title: 'Building React Communities Outside of Your Circle',
		speaker: {
			avatar: '//www.gravatar.com/avatar/33398b7cfbfa5877a16ab9a0fb0ee303?s=128',
	...
	'feather-knee': {
		content: 'How does Netflix select which new content to offer from a myriad of choices? The service is famously data-driven, but sometimes there is very little data to inform decisions. Data science meets art. Learn about a prediction tool that was recently redesigned, expanded and re-written in React.',
		title: 'Building Applications for a Studio in the Cloud at Netflix',
		speaker: {
			avatar: '//www.gravatar.com/avatar/9d78b84e1e017c2881a07f44c72267eb?s=128',
			name: 'Feather Knee',
			twitter: 'featherart',
		},
		time: {
	...
	'adam-perry': {
		content: 'A presentation of the create-react-native-app (CRNA) tool. CRNA follows in the well-trodden path of create-react-app, providing a cross-platform, boilerplate-free developer experience for new React Native projects. CRNA is the product of a collaboration between Exponent, Facebook, and open-source contributors.',
		title: 'Create React Native App: 5 Minutes to "Hello, World!"',
		speaker: {
			avatar: '//www.gravatar.com/avatar/8e9af27762850ca9fc9984eb8ff21259?s=128',
	...
	'aditya-punjani': {
		...
		speaker: {
			avatar: '//www.gravatar.com/avatar/35b89a4817380740e0992beeda327f54?s=128',
	...
	'samer-buna': {
		content: 'GraphQL is the future, and you can use it today in React applications with minimal changes. No fancy frameworks are needed. Start using GraphQL right away to get the power of composition and declarative data requirements and work with more efficient APIs.',
		title: 'You Don\'t Need a Fancy Framework to Use GraphQL with React',
		speaker: {
			avatar: '//www.gravatar.com/avatar/4b6b338a1609ea0a4dfec74208425620?s=128',
	...
	'sophia-shoemaker': {
		content: 'AWS Lambda is an event-driven, "serverless" service that makes it easier and cheaper than ever to get an application up and running. In this talk I\'ll dive into some of the details of what AWS Lambda is, how it works, how to integrate it with another AWS service, API Gateway and how you can "go serverless" with React applications.',
		title: 'AWS Lambda + AWS Gateway + React = AWEsome',
		speaker: {
			avatar: '//www.gravatar.com/avatar/862e513be39c4338bf939dede21ce271?s=128',
	...
	'neehar-venugopal': {
		content: 'The most performant code is code that never runs. Modern web apps are bigger in size that ever before, and the idea of Shipping Less JavaScript™ feels like a pipe dream. Until now. Thanks to modern bundlers, ES6 module magic and the brand new import() proposal, JavaScript finally has an idiomatic way of delivering parts of your web app when it\'s needed. This talk is meant to show how you can start using import() today to load smaller, faster code with minimal effort.',
		title: 'A Beginner\'s Guide to Code Splitting Your React App',
		speaker: {
			avatar: '//www.gravatar.com/avatar/86d9c5bbb33f358f1169bf102d50d25b?s=128',
